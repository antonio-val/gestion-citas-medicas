...
public interface AppointmentRepository extends JpaRepository<Appointment, Long>{
    ...
    """)
	boolean existsOverlappingAppointment(@Param("newStart") LocalDateTime newStart, @Param("newEnd") LocalDateTime newEnd);
	...
	@Query("""
        ...
        AND a.endDateTime > :newStart
    """)
		boolean existsOverlappingAppointmentExcludingSelf(@Param("newStart") LocalDateTime newStart, @Param("newEnd") LocalDateTime newEnd, @Param("currentAppointmentId") Long currentAppointmentId);
}
